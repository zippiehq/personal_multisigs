...
contract ZippieMultisigWallet{
    ...
    function redeemCheck(address[] addresses, address[] allSignersPossible, uint8[] m, uint8[] v, bytes32[] r, bytes32[] s, uint256 nonce, uint256 amount, bytes32[] cardDigests) public {
        ...
        require(verifySignatures(m, allSignersPossible.length, v, r, s, 1, cardDigests.length), "Invalid check signatures");
    ...
    function redeemBlankCheck(address[] addresses, address[] allSignersPossible, uint8[] m, uint8[] v, bytes32[] r, bytes32[] s, uint256 amount, bytes32[] cardDigests) public {
        ...
        require(verifySignatures(m, allSignersPossible.length, v, r, s, 2, cardDigests.length), "Invalid blank check signatures");
    ...
    function verifySignatures(uint8[] m, uint256 nrOfSigners, uint8[] v, bytes32[] r, bytes32[] s, uint256 offset, uint256 nrOfCards) internal pure returns(bool successfulVerification) {
        return 
