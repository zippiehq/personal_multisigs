...
contract ZippieWallet is ZippieMultisig, ZippieNonce, ZippieCard {
    ...
    function verifyMultisigParameters(uint256 nrOfAddresses, uint256 nrOfSigners, uint8[] memory m, uint256 nrOfVs, uint256 nrOfRs, uint256 nrOfSs, uint256 nrOfCardNonces, bool amountLimitExceeded) private pure {
